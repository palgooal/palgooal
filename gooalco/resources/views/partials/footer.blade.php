...
<div class="col-sm-3">
<h4>{{__('footer.IMPORTANTLINKS')}}</h4>
<ul class="footer-links nopadding mt30">
<li><a href="/pages/privacy-policy">{{__('footer.Privacy & Policy')}}</a></li>
<li><a href="/pages/terms-conditions">{{__('footer.Terms & Conditions')}}</a></li>
<li><a href="https://clientgooal.palgooal.com/submitticket.php?step=2&deptid=1">{{__('footer.Support')}}</a></li>
</ul>
</div>
...
<li><a href="#">{{__('footer.VPSHosting')}}</a></li>
...
<ul class="footer-links nopadding mt30">
<li><a href="https://clientgooal.palgooal.com/submitticket.php?step=2&deptid=1"><i class="fa fa-phone"></i>{{__('footer.callus')}}</a></li>
